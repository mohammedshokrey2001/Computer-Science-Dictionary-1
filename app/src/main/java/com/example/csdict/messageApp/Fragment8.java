...
public class Fragment8 extends Fragment {
    ...
    void adapter(){
        ...
        all_messages =  db.schMessages(data_mails,"MESSAGES_SENDER");
        ...
        listener = new ViewAdapterMessages.RecycleViewListener() {
            ...
            public void onClick(View v, int postion) {
              ...
              ///  String sender = all_messages.get(postion).getSender();
                ...
                intent.putExtra("sender",all_messages.get(postion).getReceiver()) ;
            ...
            public boolean onLongClick(View v, int postion) {
                deleteMessage(String.valueOf(all_messages.get(postion).getId()));
               return true;
            }
        };
